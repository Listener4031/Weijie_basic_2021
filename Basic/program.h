 ...
 */
    ...
    map <int,std::string> number_to_sourceline;
    map <int,std::string> ::iterator iter_number_to_sourceline;
    map <int,Statement*> number_to_statement_ptr;
    map <int,Statement*> ::iterator iter_number_to_statement_ptr;
